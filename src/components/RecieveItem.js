...
const RecieveItem = React.memo((props) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.imageContainer}>
                <Pressable beforeCol={"white"} afterCol={"white"} onPress={() => setModalVisible(!modalVisible)} style={styles.imageBox}>
                    <Text style={styles.userName}>{props.name}</Text>
...
export default memo(RecieveItem);
